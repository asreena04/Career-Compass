...
const EditDeleteCompetitionPage = () => {
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <header className="w-full bg-gradient-to-r from-black via-black to-black border-b border-gray-800 shadow-2xl">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-slate-500 mt-1 font-medium italic">Manage and track your active listings.</p>
        </div>
      </header>
...
export default EditDeleteCompetitionPage;