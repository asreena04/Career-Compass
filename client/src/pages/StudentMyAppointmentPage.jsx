...
const StudentMyAppointmentPage = () => {
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <header className="w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-800 shadow-2xl">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-gray-400 text-lg mt-2">View and manage your scheduled meetings</p>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="flex-1">
            <MyAppointment userRole="student" />
          </div>
        </div>
      </div>
    </div>
...
export default StudentMyAppointmentPage;